    ...
    <div className="max-w-7xl mx-auto px-4 py-20 bg-gray-50/30">
      ...
      <div className="text-center mb-24 border-b border-gray-200 pb-12">
        ...
        <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
          Търговската архитектура на Turg.bg съчетава стриктната нормативна рамка на класическите публични продажби с авангардни софтуерни протоколи за финансова защита и транзакционна сигурност. Принципите на работа осигуряват пълна равнопоставеност и нулев риск от пазарни манипулации.
        </p>
      </div>
